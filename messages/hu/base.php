...
return [
    ...
    'Body too long.' => 'Az üzenet túl hosszú.',
    'Body too too short.' => 'Az üzenet túlságosan rövid.',
...
Egy azonos üzenettel rendelkező SMS túl gyakran lett elküldve az elmúlt 180 másodpercben.',
    ...
    'To be able to send a sms to a specific account, make sure the profile field "mobile" exists in the account information.' => 'Ahhoz, hogy SMS-t küldhessen egy megadott fióknak, győződjön meg róla, hogy a fiókinformációban szerepel a "mobil" profilmező.
.',
    'Unknown route.' => 'Ismeretlen útvonal.',
    'Username' => 'Felhasználónév',
    'Within this configuration you can choose between different sms-providers and configurate these. You need to edit your account information for the chosen provider properly to have the sms-functionality work properly.' => 'Ebben a beállításban választhat a különböző SMS-szolgáltatók között, és konfigurálhatja azokat. Az SMS-funkció megfelelő működéséhez pontosan meg kel adnia a kiválasztott szolgáltató fiókadatait.',
    'Back' => '',
];
